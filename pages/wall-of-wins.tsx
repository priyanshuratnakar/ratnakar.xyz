          ...
          <Flex flexDir={"column"} gap={"30px"}>
            ...
            <Flex gap={"30px"} flexDir={"column"}>
              ...
              <Flex
                ...
                >
              <Text> 
              <Text>Pradhan Mantri Bal Shakti Purushkar (nominated) - 2021</Text>
              <Text>CogX Voice of GenZ (semifinalist) - 2020</Text>
              <Text>Male Entrepreneur of The year - 2019</Text>
              <Text>Prestigious Indian of The Year - 2019</Text>
              <Text>Incredible Indian Icon Award - 2019</Text>
              <Text>India Star Passion Award - 2019</Text>
              <Text>Kalam Youth Leadership Award - 2019</Text>
              <Text>Think Mobile with Google - 2018</Text>
              <Text>Doodle for Google (semifinalist)- 2016</Text>
              </Text>
              </Flex>
